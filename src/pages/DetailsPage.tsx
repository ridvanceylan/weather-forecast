    ...
    return (
      <div className="p-6 text-center">
        <p className="text-lg text-gray-700 dark:text-gray-300">
          {intl.formatMessage({ id: 'data-not-found', defaultMessage: 'Data not found. Please go back and select a day.' })}
        </p>
        <button
          onClick={() => navigate('/')}
      ...
      <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl space-y-6 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-lg text-gray-500 dark:text-gray-400 mt-2">
            {summary || intl.formatMessage({ id: 'no-summary', defaultMessage: 'No summary available' })}
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6 text-center text-lg mt-8">
          ...
          <div className="p-4 bg-gray-100 dark:bg-gray-700 rounded-xl shadow-lg">
            <strong className="text-gray-800 dark:text-gray-200">
              {intl.formatMessage({ id: 'pressure', defaultMessage: 'Pressure:' })}
            </strong> 
            {pressure} hPa
          </div>
          <div className="p-4 bg-gray-100 dark:bg-gray-700 rounded-xl shadow-lg">
            <strong className="text-gray-800 dark:text-gray-200">
              {intl.formatMessage({ id: 'cloudiness', defaultMessage: 'Cloudiness:' })}
            </strong> 
            {clouds}%
          </div>
          <div className="p-4 bg-gray-100 dark:bg-gray-700 rounded-xl shadow-lg">
            <strong className="text-gray-800 dark:text-gray-200">
              {intl.formatMessage({ id: 'uv-index', defaultMessage: 'UV Index:' })}
            </strong> 
            {uvi}
          </div>
          <div className="p-4 bg-gray-100 dark:bg-gray-700 rounded-xl shadow-lg">
            <strong className="text-gray-800 dark:text-gray-200">
              {intl.formatMessage({ id: 'wind-speed', defaultMessage: 'Wind Speed:' })}
            </strong> 
            {wind_speed} m/s
          </div>
          <div className="p-4 bg-gray-100 dark:bg-gray-700 rounded-xl shadow-lg">
            <strong className="text-gray-800 dark:text-gray-200">
              {intl.formatMessage({ id: 'wind-direction', defaultMessage: 'Wind Direction:' })}
            </strong> 
            {wind_deg}°
          </div>
          <div className="p-4 bg-gray-100 dark:bg-gray-700 rounded-xl shadow-lg">
            <strong className="text-gray-800 dark:text-gray-200">
              {intl.formatMessage({ id: 'precipitation', defaultMessage: 'Precipitation Probability:' })}
            </strong> 
            {pop}%
          </div>
          <div className="p-4 bg-gray-100 dark:bg-gray-700 rounded-xl shadow-lg">
            <strong className="text-gray-800 dark:text-gray-200">
              {intl.formatMessage({ id: 'sunrise', defaultMessage: 'Sunrise:' })}
            </strong> 
            {formatTime(sunrise)}
          </div>
          <div className="p-4 bg-gray-100 dark:bg-gray-700 rounded-xl shadow-lg">
          ...
          <div className="p-4 bg-gray-100 dark:bg-gray-700 rounded-xl shadow-lg">
            <strong className="text-gray-800 dark:text-gray-200">
              {intl.formatMessage({ id: 'moonrise', defaultMessage: 'Moonrise:' })}
            </strong> 
            {formatTime(moonrise)}
          </div>
          <div className="p-4 bg-gray-100 dark:bg-gray-700 rounded-xl shadow-lg">
            <strong className="text-gray-800 dark:text-gray-200">
              {intl.formatMessage({ id: 'moonset', defaultMessage: 'Moonset:' })}
            </strong> 
            {formatTime(moonset)}
          </div>
        </div>
