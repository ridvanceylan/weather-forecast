...
const SearchBar: React.FC<SearchBarProps> = ({ onSearch }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex items-center gap-4 max-w-3xl mx-auto p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
      <div className="relative w-full">
        <input
          type="text"
          value={input}
          onChange={(e) => setInput(e.target.value)}
          placeholder={intl.formatMessage({ id: 'searchCityPlaceholder', defaultMessage: 'Search city...' })}
